...
<form action="i_livro.php" method="GET">
...
<center><h3>Cadastrar o livro</h3></center>
...
<br/>
   <center><p><button type="submit" class="btn btn-success col-sm-4" name="ncadastrar">Cadastrar</button></p><center>
